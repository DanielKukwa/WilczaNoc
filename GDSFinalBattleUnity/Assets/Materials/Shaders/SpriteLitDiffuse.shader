Shader "Sprites/SpriteLit"
{
    Properties
    {
        [NoScaleOffset]_MainTex("MainTexture", 2D) = "white" {}
        _Color("Color", Color) = (1, 0, 0, 1)
        Vector1_93D6DAC2("AlphaThreshold", Range(0, 1)) = 0
        Vector1_495221C9("Light Power Reflection", Float) = 1
    }
    SubShader
    {
        Tags
        ...
        #pragma instancing_options renderinglayer
            ...
            //-------------------------------------------------------------------------------------
                    ...
                    float4 _Color;
                    float Vector1_93D6DAC2;
                    float Vector1_495221C9;
                    CBUFFER_END
                    TEXTURE2D(_MainTex); SAMPLER(sampler_MainTex); float4 _MainTex_TexelSize;
                    SAMPLER(_SampleTexture2D_A9FE4D87_Sampler_3_Linear_Repeat);
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        float4 _SampleTexture2D_A9FE4D87_RGBA_0 = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, IN.uv0.xy);
                        float _SampleTexture2D_A9FE4D87_R_4 = _SampleTexture2D_A9FE4D87_RGBA_0.r;
        ...
        #pragma instancing_options renderinglayer
            ...
            //-------------------------------------------------------------------------------------
                ...
                // Pixel Graph Evaluation
                    ...
                    {
                        SurfaceDescription surface = (SurfaceDescription)0;
                        float4 _Property_77A50D00_Out_0 = _Color;
                        float4 _SampleTexture2D_A9FE4D87_RGBA_0 = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, IN.uv0.xy);
                        float _SampleTexture2D_A9FE4D87_R_4 = _SampleTexture2D_A9FE4D87_RGBA_0.r;
                        float _SampleTexture2D_A9FE4D87_G_5 = _SampleTexture2D_A9FE4D87_RGBA_0.g;
                        float _SampleTexture2D_A9FE4D87_B_6 = _SampleTexture2D_A9FE4D87_RGBA_0.b;
                        float _SampleTexture2D_A9FE4D87_A_7 = _SampleTexture2D_A9FE4D87_RGBA_0.a;
                        float4 _Multiply_348A7E1F_Out_2;
                        Unity_Multiply_float(_Property_77A50D00_Out_0, _SampleTexture2D_A9FE4D87_RGBA_0, _Multiply_348A7E1F_Out_2);
                        float _Property_629044D5_Out_0 = Vector1_495221C9;
                        float4 _Multiply_DCF4741D_Out_2;
                        Unity_Multiply_float(_Multiply_348A7E1F_Out_2, (_Property_629044D5_Out_0.xxxx), _Multiply_DCF4741D_Out_2);
                        surface.Albedo = (_Multiply_DCF4741D_Out_2.xyz);
